namespace WebApplication1.Data
{
    ...
    {
        private static IWebsiteDbContext _context;

        public DataSeeder(IWebsiteDbContext context)
        {
            _context = context;
        }
        public async Task Seed(CancellationToken cancellationToken)
        {
            ...
            await SeedCakes(cancellationToken);

            await SeedEmployees(cancellationToken);
        }

        private async Task SeedCustomers(CancellationToken cancellationToken)
        {
        ...
        private async Task SeedCakes(CancellationToken cancellationToken)
        {
            _context.Cakes.Add(new Cake
            {
                Name = "Chocolate Cake",
                Price = 5
               ,
        ...
        private async Task SeedEmployees(CancellationToken cancellationToken)
        {
